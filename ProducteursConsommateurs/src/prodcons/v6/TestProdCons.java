...
public class TestProdCons {
	...
	public static void main(String[] args) {
		...
		// maxPut is the maximum number a producer thread can put at a time. number of a
		// put is decided randomly between 0 and maxPut included
		int maxPut = Integer.parseInt(properties.getProperty("maxPut"));
		...
		for (int i = 0; i < nProd; i++) {
			Producer p = new Producer(buff, prodTime, minProd, maxProd, maxPut);
			prods[i] = p;
			p.start();
		}
